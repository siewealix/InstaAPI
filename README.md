...
Le projet contient aussi une partie **gestion des utilisateurs** (client / admin) côté API.
...
- (La gestion utilisateurs est actuellement surtout exposée côté API)
...
> Remarque : la création d’admin et certaines opérations utilisateur existent dans le service,  
> mais toutes ne sont pas encore exposées comme endpoints actifs dans le contrôleur.
...
- La partie utilisateurs distingue deux profils dans les DTO : **client** et **admin**.
